package com.ecom.cartservice.interceptor;
	...
	public boolean preHandle(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response,
		...
		try {
			...
			if (StringUtils.hasText(authHeader)) {
				token = authHeader.startsWith(CartServiceConstants.BEARER_PREFIX)
						? authHeader.substring(CartServiceConstants.BEARER_TOKEN_START_INDEX)
						: authHeader;
			}
