...
public class CartDto {
    ...
    public static class CartResponse extends com.ecom.cartservice.dto.CartResponse {
        ...
        public CartResponse(Long id, Long userId, java.util.List<CartItemResponse> items, Integer totalItems, 
                           java.math.BigDecimal totalPrice, java.time.LocalDateTime createdAt, java.time.LocalDateTime updatedAt) {
            super(id, userId, items.stream().map(item -> (com.ecom.cartservice.dto.CartResponse.CartItemResponse) item).toList(), totalItems, totalPrice, createdAt, updatedAt);
        }
        ...
        public static class CartItemResponse extends com.ecom.cartservice.dto.CartResponse.CartItemResponse {
            ...
            public CartItemResponse(Long id, Long productId, String productName, String productDescription,
                                   ...
                                   java.math.BigDecimal currentPrice, java.math.BigDecimal totalPrice, java.time.LocalDateTime addedAt) {
                super(id, productId, productName, productDescription, productImageUrl, quantity, 
                      priceAtAddition, currentPrice, totalPrice, addedAt);
            }
        }
    }
}
