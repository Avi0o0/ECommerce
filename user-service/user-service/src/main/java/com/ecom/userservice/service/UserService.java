...
public class UserService {
    ...
    public boolean verifyPassword(Long id, VerifyPasswordRequest request) {
        UserAccount user = getUserById(id);
        try {
    ...
    public List<com.ecom.userservice.dto.OrderSummaryResponse> getUserOrders(Long id, String authorization, String requesterUsername) {
